...
$.fn.dropdown.settings.templates = {
  ...
  dropdown: function(select) {
    var
      ...
      html        = ''
    ;
    html +=  '<svg class="ngl-dropdown-arrow" stroke="#666" fill="none" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>';
