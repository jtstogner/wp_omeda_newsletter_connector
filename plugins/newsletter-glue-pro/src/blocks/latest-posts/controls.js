...
export const Controls = props => {
  ...
  if (attributes.cta_type === 'link' && attributes.show_cta) {
    colors.push({ value: 'link', label: 'Link', default: theme.colors.primary, required: true });
  }

  if (attributes.cta_type === 'button' && attributes.show_cta) {
    colors.push({ value: 'button', label: 'Button', default: theme.colors.btn_bg, required: true });
    colors.push({ value: 'button_text', label: 'Button text', default: theme.colors.btn_colour, required: true });
  }
  ...
  const typographySettings = [
    ...
    { value: 'font_title', label: 'Font family', default: theme.font, type: 'customselect', options: fonts, is_single: true },
    { value: 'fontsize_title', label: 'Font size', default: theme.posts.fontsize_title, type: 'unit', is_single: true },
    ...
    { value: 'fontsize_text', label: 'Font size', default: theme.posts.fontsize_text, type: 'unit', is_single: true },
    ...
    { value: 'fontsize_label', label: 'Label font size', default: theme.posts.fontsize_label, type: 'unit', is_single: true },

    { type: 'section', label: 'Author' },
    { value: 'font_author', label: 'Font family', default: theme.font, type: 'customselect', options: fonts, is_single: true },
    { value: 'fontsize_author', label: 'Font size', default: theme.posts.fontsize_author, type: 'unit', is_single: true },
    ...
    { value: 'fontsize_button', label: 'Font size', default: theme.posts.fontsize_button, type: 'unit', is_single: true },
  ];

  const spacingSettings = [
    { value: 'padding', label: 'Padding', default: theme.posts.padding, type: 'boxcontrol' },
    { value: 'margin', label: 'Margin', default: theme.posts.margin, type: 'boxcontrol' },
  ];
