...
export const Controls = props => {
  ...
  const resetSpacing = () => {
    setAttributes({
      padding: theme.embed.padding,
      margin: theme.embed.margin,
    });
  };
  ...
  const spacingSettings = [
    { value: 'padding', label: 'Padding', default: theme.embed.padding, type: 'boxcontrol' },
    { value: 'margin', label: 'Margin', default: theme.embed.margin, type: 'boxcontrol' },
  ];
