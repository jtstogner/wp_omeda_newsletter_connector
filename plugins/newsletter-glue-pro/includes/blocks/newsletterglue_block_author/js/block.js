( function( blocks, editor, element, components ) {
	...
	const { TextControl, SelectControl, ToggleControl, Panel, PanelBody, PanelRow, RangeControl, BaseControl, ButtonGroup, Button, __experimentalBoxControl } = components;
	...
	registerBlockType( 'newsletterglue/author', {
		...
		keywords: [ 'newsletter', 'author', 'user' ],
		attributes: {
			social: {
				'type': 'string',
				'default' : 'twitter',
		...
		edit: withColors( 'formColor' ) ( function( props ) {
			...
			var profile_pic = newsletterglue_meta.profile_pic ? newsletterglue_meta.profile_pic : '';
			...
			var userImage = props.attributes.profile_pic ? props.attributes.profile_pic : profile_pic;
			...
			if ( platform == 'twitter' ) {
				...
				var followURL = 'https://www.linkedin.com/in/' + username;
			}
			...
			return (
				...
				el( Fragment, {},
					...
					el( 'div', { className: 'ngl-author', style: boxStyles, 'data-padding': top_padding + ',' + bottom_padding + ',' + left_padding + ',' + right_padding, 'data-margin' : top_margin + ',' + bottom_margin },
		...
		save: function( props, className ) {
			...
			var authorName = newsletterglue_meta.author_name ? newsletterglue_meta.author_name : '';
			var authorBio  = newsletterglue_meta.author_bio ? newsletterglue_meta.author_bio : '';
					...
					el( 'div', { className: 'ngl-author', style: boxStyles, 'data-padding': top_padding + ',' + bottom_padding + ',' + left_padding + ',' + right_padding, 'data-margin' : top_margin + ',' + bottom_margin },
						...
						el( 'div', { className: 'ngl-author-meta' },
							el( RichText.Content, {
								tagName: 'div',
								className: 'ngl-author-name',
								value: showName? showName : authorName,
							} ),
							el( 'div', { className: 'ngl-author-bio' },
								el( RichText.Content, {
									tagName: 'span',
									value: showBio ? showBio : authorBio,
									className: 'ngl-author-bio-content',
								} )
							),
							show_cta
