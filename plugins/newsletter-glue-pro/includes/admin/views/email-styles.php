...
<head>
	...
	<?php if ( ! empty( $_GET[ 'view_newsletter' ] ) ) : // phpcs:ignore ?>
	<title>{{ ng.title }}</title>
	<?php endif; ?>

	<?php do_action( 'newsletterglue_insert_after_title' ); ?>
	...
	<style type="text/css">
		...
		<?php
			...
			do_action( 'newsletterglue_add_custom_styles', $post );
		?>

	</style>

	<?php do_action( 'newsletterglue_insert_after_style' ); ?>
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="margin-top: 0; margin-right: 0; margin-bottom: 0; margin-left: 0;padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0;" yahoo="fix">
							...
							<tr>
								<td>
									<table width="600" id="template_table" align="center" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td align="center" id="template_inner" style="overflow-wrap: break-word; word-wrap: break-word; word-break: break-word;">{{ ng.content }}</td>
										</tr>
										<tr>
											<td align="center" id="template_end" style="overflow-wrap: break-word; word-wrap: break-word; word-break: break-word;">{{ ng.end }}</td>
										</tr>
									</table>
								</td>
							</tr>
	...
	<?php do_action( 'newsletterglue_email_before_closing_body' ); ?>
