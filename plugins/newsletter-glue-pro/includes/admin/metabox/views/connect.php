...
<div class="ngl-metabox ngl-no-connection">
	...
	<?php if ( ! defined( 'NEWSLETTERGLUE_DEMO' ) ) { ?>
	...
	<div class="ngl-metabox-flex ngl-metabox-flex-toggle">
		...
		<div class="ngl-field ngl-field-master">
			...
			<label for="ngl_send_newsletter">
				<?php _e( 'Send as newsletter', 'newsletter-glue' ); ?>
				<?php if ( ! newsletterglue_is_automation() ) : ?>
				<span class="ngl-field-master-help"><?php _e( '(when post is published/updated)', 'newsletter-glue' ); ?></span>
				<?php endif; ?>
			</label>
		</div>
