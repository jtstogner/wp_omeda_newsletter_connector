...
.newsletterglue-popup-header h2 {
	margin: 0;
	background: url( <?php echo esc_url( NGL_PLUGIN_URL  ). 'assets/images/menu.png'; ?> ) no-repeat left center;
...
<div class="newsletterglue-popup-overlay">
  ...
  <div class="newsletterglue-serveypanel">
    ...
    <div class="newsletterglue-popup-body">
      ...
      <input type="hidden" class="newsletterglue_deactivate_nonce" name="newsletterglue_deactivate_nonce" value="<?php echo esc_attr( $newsletterglue_deactivate_nonce ); ?>">
...
$(function() {
	...
	var plugin_ = '<?php echo esc_attr( plugin_basename( NGL_PLUGIN_FILE ) ); ?>';
