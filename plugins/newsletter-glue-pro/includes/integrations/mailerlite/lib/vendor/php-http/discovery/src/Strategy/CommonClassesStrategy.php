...
final class CommonClassesStrategy implements DiscoveryStrategy
{
    ...
    private static function getPsr18Candidates()
    {
        ...
        foreach (self::$classes[HttpClient::class] as $c) {
            try {
                ...
                trigger_error(sprintf('Got exception "%s (%s)" while checking if a PSR-18 Client is available', get_class($e), $e->getMessage()), E_USER_WARNING); // phpcs:ignore
            }
        }
    ...
    public static function isPsr17FactoryInstalled()
    {
        try {
            ...
            trigger_error(sprintf('Got exception "%s (%s)" while checking if a PSR-17 ResponseFactory is available', get_class($e), $e->getMessage()), E_USER_WARNING); // phpcs:ignore
