...
/**
 * NGL_REST_API_Reset_Roles class.
 */
class NGL_REST_API_Reset_Roles {
	...
	public function __construct() {
		...
		register_rest_route( 'newsletterglue/' . newsletterglue()->api_version(), '/reset_roles', array(
			'methods' 	=> 'POST',
...
return new NGL_REST_API_Reset_Roles();