...
export default class Connections extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    // Check if connectionStatus > 0 (connected) AND notLicensed is true
    if (this.state.connectionStatus > 0 && this.props.getState.notLicensed) {
      // If the connection was just established or props just changed to notLicensed
      if (prevState.connectionStatus === 0 || !prevProps.getState.notLicensed) {
        console.log('License inactive but connection active - automatically removing connection');
