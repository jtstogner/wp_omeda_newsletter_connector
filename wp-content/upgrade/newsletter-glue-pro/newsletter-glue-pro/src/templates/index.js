...
export default class Templates extends Component {
  ...
  componentDidUpdate() {
    ...
    if (isOpen && isSearching) {
      ...
      apiFetch({
        path: 'newsletterglue/' + nglue_backend.api_version + '/get_templates?category_id=' + catID + '&query=' + searchQuery,
        method: 'get',
        headers: {
  ...
  render() {
    ...
    return (
      <>
        ...
        >
          {__('Select template', 'newsletter-glue')}
        </div>
        {isOpen && (
          <Modal
            title={__('Template Library', 'newsletter-glue')}
...
var rootElement = document.getElementById('ngl_template');
