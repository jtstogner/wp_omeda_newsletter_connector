	...
	function newsletterglue_update_input( t ) {
		...
		if ( id == 'font' ) {
			if ( value && value != '0' ) {
				...
				$( '.ngl-email' ).css( { 'font-family' : font } );
			} else {
				$( '.ngl-email' ).css( { 'font-family' : 'inherit' } );
			}
		}
		...
		if ( id == 'h1_colour' || id == 'h2_colour' || id == 'h3_colour' || id == 'h4_colour' || id == 'h5_colour' || id == 'h6_colour' || id == 'p_colour' || id == 'a_colour' ) {
			...
			$( '.ngl-email' ).find( attr ).not( '.wp-block-button__link' ).css( { 'color' : value } );
		}
		...
		// button colour.
		if ( id == 'btn_bg' ) {
			$( '.ngl-email' ).find( '.wp-block-button__link' ).css( { 'background-color' : value } );
		}
		if ( id == 'btn_colour' ) {
			$( '.ngl-email' ).find( '.wp-block-button__link' ).css( { 'color' : value } );
		}
		if ( id == 'btn_border' ) {
			$( '.ngl-email' ).find( '.wp-block-button__link' ).css( { 'border-color' : value } );
		}
		if ( id == 'btn_radius' ) {
			$( '.ngl-email' ).find( '.wp-block-button__link' ).css( { 'border-radius' : value + 'px' } );
		}
