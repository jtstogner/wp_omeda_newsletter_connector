...
class NGL_Render_Post_Embeds {
	...
	public function setup_attrs( $atts ) {
		...
		// If show_divider is set, always provide a divider_size (default to 1 if not specified)
		$args['divider_size'] = isset( $atts['show_divider'] ) ? (isset( $atts['divider_size'] ) ? absint( $atts['divider_size'] ) : 1) : null;
