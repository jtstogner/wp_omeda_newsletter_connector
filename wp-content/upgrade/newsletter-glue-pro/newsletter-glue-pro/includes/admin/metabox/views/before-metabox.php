...
<div class="ngl-metabox ngl-msgbox-wrap ngl-metabox-flex alt3 alt5 is-hidden">
	...
	<div class="ngl-msg-contain">
		<div class="ngl-top-msg">
			...
			<span class="ngl-newsletter-sent"><?php _e( 'Your email newsletter is on its way!', 'newsletter-glue' ); ?></span>
		</div>
		...
		<div class="ngl-top-msg-view">
			...
			<a href="#" class="ngl-reset-newsletter" data-post-id="<?php echo absint( $post->ID ); ?>"><?php echo esc_html__( 'Send another newsletter', 'newsletter-glue' ); ?></a>
		</div>
	</div>
		...
		<div class="ngl-top-msg">
			...
			<?php
				if ( newsletterglue_is_post_scheduled( $post->ID ) ) {
					echo '<span>' . esc_html__( 'Your email newsletter is scheduled.', 'newsletter-glue' ) . '</span>';
				} else {
					echo '<span>' . esc_html__( 'You’ve sent this post as a newsletter before.', 'newsletter-glue' ) . '</span>';
				}
			?>
		</div>
...
<div class="ngl-metabox ngl-mb-<?php echo esc_attr( $app ); ?> ngl-send <?php if ( ! $hide ) echo 'is-hidden'; ?>">
