 ...
 * Get Merge Tags.
 */
function newsletterglue_get_moosend_tags() {
		...
		'personalization'	=> array(
			...
			'tags'	=> array(
				...
				'update_preferences' => array(
					'title'		=> __( 'Update profile', 'newsletter-glue' ),
					'default_link_text' => __( 'Update profile', 'newsletter-glue' ),
				),
			),
		),
		'read_online'		=> array(
	...
	return apply_filters( 'newsletterglue_get_moosend_tags', $merge_tags );
}