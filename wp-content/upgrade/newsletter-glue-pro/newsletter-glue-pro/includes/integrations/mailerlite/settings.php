		...
		<div class="ngl-field">
			<?php
				...
				newsletterglue_select_field( array(
					'id' 			=> 'ngl_segments',
					'legacy'		=> true,
					'helper'		=> sprintf( __( 'A specific group of subscribers. %s', 'newsletter-glue' ), '<a href="https://app.mailerlite.com/subscribers/segments" target="_blank" class="ngl-link-inline-svg">' . __( 'Create segment', 'newsletter-glue' ) . ' [externallink]</a>' ),
