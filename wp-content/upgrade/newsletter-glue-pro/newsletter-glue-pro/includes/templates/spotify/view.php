...
?>
<table width="100%" cellpadding="0" cellspacing="0" class="ng-block-spotify">
	<tbody>
		<tr>
					...
					<tbody>
						<tr>
							...
							<td class="ng-block-td ngl-ignore-mrkp" style="vertical-align:top;padding-right:15px;">
								<a href="<?php echo urldecode( trim( $url ) ); ?>" rel="noopener" target="_blank"><?php echo esc_html( $data->title ); ?></a>
							</td>
							<td class="ng-block-td ngl-ignore-mrkp" style="vertical-align:top;width:30px;" width="30">
								<img src="<?php echo esc_url( NGL_PLUGIN_URL . 'assets/images/social/spotify.png' ); ?>" class="ng-image" width="30" height="30" alt="" style="width: 30px;height: auto;display: block;" />
							</td>
						</tr>
					</tbody>
				</table>
