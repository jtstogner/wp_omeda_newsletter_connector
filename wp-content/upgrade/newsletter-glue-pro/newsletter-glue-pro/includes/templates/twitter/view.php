					...
					<tbody>
						<tr>
							<td class="ng-block-td" style="width:40px;vertical-align: middle;" width="40">
								<img src="<?php echo esc_url( NGL_PLUGIN_URL . 'assets/images/social/logo-twitter.png' ); ?>" class="ng-image" width="30" height="30" alt="" style="width: 30px;height: auto;display: block;" />
							</td>
